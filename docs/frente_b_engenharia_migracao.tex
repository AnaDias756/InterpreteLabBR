...
% ---------------------------------------------------------------------
% Nota metodológica (opcional; remover se redundante com o Cap. de Metodologia):
% A classificação de portabilidade foi obtida por análise comparativa estática
% das duas bases de código no estado final do repositório, e não por registro
% em tempo real (diário de bordo). Trata-se, portanto, de uma reconstrução
% documental do mapa de migração, adequada ao caráter retrospectivo da Frente B.
% ---------------------------------------------------------------------
